...
<section class="">
				<div class="row slider">
					<!--start slider-->
					<div class="itc-slider" id="slider-1" data-slider="itc-slider">
						...
						<div class="itc-slider-items">
							...
							<div class="itc-slider-content">
								...
								<p class="slider-description">Достовірні результати лабораторних досліджень у власній лабораторії на діагностичному обладнанні експертного класу.</p>
								<a href="{{ route('price') }}" class="btn btn-green">Перелік всіх аналізів</a>
							</div>
							<div class="itc-slider-image"><img src="{{ asset('/assets/medium-shot-scientist-with-chemical-substance 1.png') }}" alt="scientist-with-chemical-substance">
							</div>
							</div>
							<div class="itc-slider-item">
							<!-- Контент 2 слайда -->
							<div class="itc-slider-content">
								<h3 class="slider-title">Всі види аналізів для дітей та дорослих</h3>
								<p class="slider-description">Достовірні результати лабораторних досліджень у власній лабораторії на діагностичному обладнанні експертного класу.</p>
								<a class="btn btn-green">Перелік всіх аналізів</a>
							</div>
							<div class="itc-slider-image"><img src="{{ asset('/assets/medium-shot-scientist-with-chemical-substance 1.png') }}" alt="scientist-with-chemical-substance">
							</div>
							</div>
