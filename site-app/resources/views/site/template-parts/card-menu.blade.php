						...
						<div class="card-items">
							<div class="card-item">
								...
								<div class="card-item-menus">
									<ul>
									<li><a class="card-item-menu" href="{{ route('all') }}">Прийом лікарів</a><i class="arrow_right"></i></li>
									<li><a class="card-item-menu" href="{{ route('online') }}">Онлайн-консультації</a><i class="arrow_right"></i></li>
							...
							<div class="card-item">
								...
								<div class="card-item-menus">
									<ul>
									<li><a class="card-item-menu" href="{{ route('price') }}">Аналізи</a><i class="arrow_right"></i></li>
									<li><a class="card-item-menu" href="#">УЗД</a><i class="arrow_right"></i></li>
									<li><a class="card-item-menu" href="#">Безоплатні дослідження</a><i class="arrow_right"></i></li>
								</ul>
								</div>
							</div>
							<div class="card-item">
